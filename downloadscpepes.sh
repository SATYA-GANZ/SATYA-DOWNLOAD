...
echo "=====================================" | lolcat
echo "THIS TOOLS WAS CREATED BY SATYA" | lolcat
echo "IF U WANT TO RECODE THIS TOOLS PLEASE PC ME +6281413250204" | lolcat
echo "AND THIS TOOLS FOR INDONESIAN SECURITY DOWN" | lolcat
